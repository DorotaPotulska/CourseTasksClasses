package JavaGda34.weekend5.zad17_samochod_optional_DOKONCZYC;
...
public class Sklep {
        ...
        for (int a : indeksyFiltrow) {
            switch (a) {
                case 1:
                    ...
                    setFiltrMarki(Optional.of(scanner.nextLine().trim()));
                    break;
                case 2:
                    System.out.println("Podaj szukany kolor:");
                    setFiltrKoloru(Optional.of(scanner.nextLine().trim()));
                    break;
                case 3:
                    System.out.println("Podaj szukany model:");
                    setFiltrModelu(Optional.of(scanner.nextLine().trim()));
                    break;
                case 4:
   ...
   /* private void znajdz() {
        filtrMarki.ifPresent((s)-> this.przefiltrowanaListaSamochodow = przefiltrowanaListaSamochodow.stream()
                    .filter(auto -> auto.getMarka().equalsIgnoreCase(filtrMarki.toString(s))
