...
public class Computer {
    ...
    private final int powerSupplyValue;
        ...
        //    private Computer(String processorModel, double processorClock, String gpuModel, String motherboardModel, int ramSize, int diskSize, DiskType diskType, int powerSupplyValue) {
...
//        this.disks.add(new Disk(diskSize, diskType));
